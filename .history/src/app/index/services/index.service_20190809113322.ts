...
saveGstr3bInvoice(savegstr3bInvoice):Observable<gstr3bobject>{
  return this.http.post<gstr3bobject>("http://localhost:8080/gst/rest/FileGSTR3BData/createFileGSTR3BData",savegstr3bInvoice).pipe(
...
saveGstr2Invoice(savegstr2Invoice):Observable<gstr3bobject>{
  return this.http.post<gstr3bobject>("http://localhost:8080/gst/rest/FileGSTR3BData/createFileGSTR3BData",savegstr2Invoice).pipe(
    catchError(this.handleError)
    );
 }
