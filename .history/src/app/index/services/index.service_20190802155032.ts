...
import { fullobject } from './../../../../.history/src/app/home/invoice_20190802143731';
...
saveGstInvoice(saveInvoice): Observable<fullobject>{
  return this.http.post<fullobject>("http://192.168.2.167:8080/gst/rest/gstr1/save",saveInvoice);
 }
