...
import { fullobject } from 'src/app/home/invoice/invoice';
...
//  GSTR3B invoice starts
saveGstr3bInvoice(savegstr3bInvoice):Observable<gstr3bobject>{
  return this.http.post<gstr3bobject>("http://192.168.2.167:8080/gst/rest/FileGSTR3BData/createFileGSTR3BData",savegstr3bInvoice).pipe(
...
//  GSTR2 invoice starts
saveGstr2Invoice(savegstr2Invoice):Observable<gstr3bobject>{
  return this.http.post<gstr3bobject>("http://192.168.2.167:8080/gst/rest/GSTR2Data/SaveGSTR2Data",savegstr2Invoice).pipe(
    catchError(this.handleError)
    );
 }
//  GSTR3B invoice ends
