...
gstin = sessionStorage.getItem('gstInNum');

fp = sessionStorage.getItem('returnPeriod');
ctin =sessionStorage.getItem('returnPeriod');

getgstr2b2bdata():Observable<any>{
  return this.http.get('http://192.168.2.167:8084/gst/rest/GSTR2Data/getB2BInvoices/abcde/abcde/abcde');
}
