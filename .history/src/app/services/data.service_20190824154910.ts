...
saveGstr2b2bur(reqobj){
  return this.http.post('http://192.168.2.167:8084/gst/rest/GSTR2Data/getB2BInvoices/abcde/abcde/abcde/'+ this.gstin+'/'+this.fp+'/'+this.ctin,reqobj)
}
//save methods end

//get methods for gstr2 ends
