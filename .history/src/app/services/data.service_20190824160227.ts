...
//save methods start
saveGstr2(reqobj){
  return this.http.post('http://192.168.2.167:8084/gst/rest/GSTR2Data/SaveGSTR2Data'+ this.gstin+'/'+this.fp+'/'+this.ctin,reqobj)
}
//save methods end
...
//save methods start
saveGstr2b2b(reqobj){
  return this.http.post('http://192.168.2.167:8084/gst/rest/GSTR2Data/getB2BInvoices/'+ this.gstin+'/'+this.fp+'/'+this.ctin,reqobj)
}
saveGstr2cdn(reqobj){
  return this.http.post('http://192.168.2.167:8084/gst/rest/GSTR2Data/getCDNInvoices/'+ this.gstin+'/'+this.fp+'/'+this.ctin,reqobj)
}
saveGstr2b2bur(reqobj){
  return this.http.post('http://192.168.2.167:8084/gst/rest/GSTR2Data/getB2BUnregisteredInvoices/'+ this.gstin+'/'+this.fp+'/'+this.ctin,reqobj)
}
//save methods end
