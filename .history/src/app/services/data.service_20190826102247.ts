...
gstin3b = sessionStorage.getItem('gstin');

ret_period = sessionStorage.getItem('ret_period');

//get method for gstr3b starts
getgstr3b():Observable<any>{
  return this.http.get('http://192.168.2.167:8080/gst/rest/FileGSTR3BData/GetGSTR3BDataBYJSTIN/'+this.gstin3b +'/'+this.ret_period)
}
//get method for gstr3b ends
//save gstr3b invoice starts
saveGstr3bInvoice(savegstr3bInvoice):Observable<any>{
  return this.http.post("http://192.168.2.167:8080/gst/rest/FileGSTR3BData/createFileGSTR3BData",savegstr3bInvoice)
  }
...
ctin = localStorage.getItem('ctin');
