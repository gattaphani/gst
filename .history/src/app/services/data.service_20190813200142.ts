...
//b2csa stared
getb2csa():Observable<any>
{
  return this.http.get('http://192.168.2.149:8081/gst/rest/gstr1/findb2csa/27AHQPA7588L1ZJ/122019');
}
//b2csa ended

//b2cla stared
getb2cla():Observable<any>
{
  return this.http.get('http://192.168.2.149:8081/gst/rest/gstr1/findb2cla/27AHQPA7588L1ZJ/122019');
}
//b2cla ended
//gst registration starts
getgstregistration():Observable<any>
{
  return this.http.get('http://192.168.2.183:8083/gst/rest/CustomerRegistration/getAllCustomerRegistration');
}
//gst registration ends

//state started
getstatedata():Observable<any>{
  return this.http.get('http://192.168.2.167:8080/gst/rest/state/getStateList');
}
addstate(formData): Observable<any>{
