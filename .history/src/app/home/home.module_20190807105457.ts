...
@NgModule({
  declarations: [DashboardComponent, HelpComponent, UsersComponent, EthenicgroupComponent,
    StatusComponent,SpecialeventComponent, UserdetailsComponent, ServicerequestComponent, TestcodeComponent, PostalcodeComponent, ApplicationlistComponent, RegisteredcandidateComponent, AdministrativeuserComponent, EmployementtypeComponent, PositiontypeComponent, PositionsComponent, CategoryComponent, FeestructureComponent, DesignationComponent, ApplicationComponent, EmployeementinfoComponent, VerifyComponent, UserlistComponent, TaxpayerComponent, StateComponent, DistrictComponent, B2claComponent, InvoiceComponent, B2csaComponent, Gstr3bComponent],
  imports: [
