...
@NgModule({
  declarations: [DashboardComponent, HelpComponent, UsersComponent, EthenicgroupComponent,StatusComponent,SpecialeventComponent, 
    ...
    B2csComponent, B2csaComponent, Gstr1Component, Gstr3bComponent, Gstr2Component, Addb2bComponent, Addb2clComponent, 
    Addb2claComponent, B2baComponent, CdnrComponent, ExpComponent, ExpaComponent, NilComponent, TxpdComponent, TxpdaComponent,
     DocissueComponent, CdnurComponent, CdnuraComponent, CdnraComponent, HsnComponent, Addb2baComponent, AddcdnrComponent, 
     AddcdnraComponent, Addb2csComponent, Addb2csaComponent, AddexpComponent, AddexpaComponent, AddhsnComponent, AddnilComponent, 
     AddtxpdComponent, AddtxpdaComponent, AdddocissueComponent, AddcdnurComponent, AddcdnuraComponent, Gstr2b2bComponent,
     Gstr2cdnComponent,Gstr2b2burComponent,Gstr2b2bformComponent,Gstr2cdnformComponent,Gstr2b2burformComponent,Gstr3b1formComponent,
     Gstr3b2formComponent,Gstr3bviewComponent
    ],
  imports: [
import { Gstr3bviewComponent } from '.../../../.history/src/app/home/gstr3bview/gstr3bview.component_20190827173217';
