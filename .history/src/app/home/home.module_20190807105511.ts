...
@NgModule({
  declarations: [DashboardComponent, HelpComponent, UsersComponent, EthenicgroupComponent,
    ...
    TestcodeComponent, PostalcodeComponent, ApplicationlistComponent, RegisteredcandidateComponent,
     ...
     EmployeementinfoComponent, VerifyComponent, UserlistComponent, TaxpayerComponent, StateComponent, 
     DistrictComponent, B2claComponent, InvoiceComponent, B2csaComponent, Gstr3bComponent],
  imports: [
