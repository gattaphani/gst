...
@NgModule({
  declarations: [DashboardComponent, HelpComponent, UsersComponent, EthenicgroupComponent,StatusComponent,SpecialeventComponent, 
    ...
    B2csComponent, B2csaComponent, Gstr1Component, Gstr3bComponent, Gstr2Component, Dashboard2Component, Gstr2b2bComponent, Gstr2b2bformComponent, Gstr2cdnComponent, Gstr2cdnformComponent, Gstr2b2burComponent, Gstr2b2burformComponent, Dashboard3Component, Gstr3b1Component, Gstr3b2Component, Gstr3b1formComponent, Gstr3b2formComponent, Gstr3bviewComponent],
  imports: [
