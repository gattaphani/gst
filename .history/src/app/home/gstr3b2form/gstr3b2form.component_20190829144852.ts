...
savegst3bobj(){
    let Gstr3bobject:gstr3bobject = 
    {
      ...
      itc_elg:
      {
        ...
        [
          {
            ty:this.gstr3bform.get('tytig').value,
            iamt:this.gstr3bform.get('iamttig').value,
            camt:this.gstr3bform.get('camttig').value,
            samt:this.gstr3bform.get('samttig').value,
            csamt:this.gstr3bform.get('csamttig').value,
          },
          {
