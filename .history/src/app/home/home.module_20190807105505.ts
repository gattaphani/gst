...
@NgModule({
  declarations: [DashboardComponent, HelpComponent, UsersComponent, EthenicgroupComponent,
    ...
    TestcodeComponent, PostalcodeComponent, ApplicationlistComponent, RegisteredcandidateComponent,
     ...
     CategoryComponent, FeestructureComponent, DesignationComponent, ApplicationComponent, 
     
     EmployeementinfoComponent, VerifyComponent, UserlistComponent, TaxpayerComponent, StateComponent, DistrictComponent, B2claComponent, InvoiceComponent, B2csaComponent, Gstr3bComponent],
  imports: [
