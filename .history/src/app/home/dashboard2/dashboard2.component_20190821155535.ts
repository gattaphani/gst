            ...
            [
              {
                ...
                txval:this.gstr2form.get('txvalhsnsumimip').value,
                rt:this.gstr2form.get('rthsnsum').value,
                iamt:this.gstr2form.get('iamthsnsum').value,
                csamt:this.gstr2form.get('csamthsnsum').value,
                tx_i:this.gstr2form.get('tx_ihsnsum').value,
                tx_cs:this.gstr2form.get('tx_cshsnsum').value,
              }
            ]
          }
        ],
