      ...
      [
        {
          ...
          inv:[
            {
              inum:this.gstr2form.get('gstin').value,
              idt:this.gstr2form.get('gstin').value,
              val:this.gstr2form.get('gstin').value,
              pos:this.gstr2form.get('gstin').value,
              rchrg:this.gstr2form.get('gstin').value,
              inv_typ:this.gstr2form.get('gstin').value,
            }
          ]
        }
      ]
