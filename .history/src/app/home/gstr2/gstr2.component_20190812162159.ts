        ...
        [
          {
            ...
            [
              {
                inum:this.gstr2form.get('ctin').value,
                idt:this.gstr2form.get('ctin').value,
                val:this.gstr2form.get('ctin').value,
                pos:this.gstr2form.get('ctin').value,
                rchrg:this.gstr2form.get('ctin').value,
                inv_typ:this.gstr2form.get('ctin').value,
                itms:
                [
                  {
                    inum:this.gstr2form.get('ctin').value,
                    itm_det:
                    {
                      rt:this.gstr2form.get('ctin').value,
                      txval:this.gstr2form.get('txval').value,
                      iamt:this.gstr2form.get('iamt').value,
                      //               camt:this.gstr2form.get('camt').value,
                      //               samt:this.gstr2form.get('samt').value,
