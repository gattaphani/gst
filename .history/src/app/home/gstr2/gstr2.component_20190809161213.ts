  ...
  savegst3bobj(){
    ...
    let Gstr2object:gstr2object = 
    {
      ...
      [
        ...
        [
          {
            is_sez:this.gstr2form.get('csamt').value,
            stin:this.gstr2form.get('csamt').value,
            boe_num:this.gstr2form.get('csamt').value,
            boe_dt:this.gstr2form.get('csamt').value,
            boe_val:this.gstr2form.get('csamt').value,
            port_code:this.gstr2form.get('csamt').value,
          }
        ]
      ]
