  ...
  savegst3bobj(){
    ...
    let Gstr2object:gstr2object = 
    {
      ...
      nil_supplies:
      {
        inter:
        {
          cpddr:this.gstr2form.get('tx_cs').value,
          exptdsply:this.gstr2form.get('tx_cs').value,
          ngsply:this.gstr2form.get('tx_cs').value,
          nilsply:this.gstr2form.get('tx_cs').value,
        }
      }
