      ...
      [
        {
          ...
          inv:[
            ...
            },
            {
              ...
              inum:this.gstr2form.get('inum').value,
              idt:this.gstr2form.get('inum').value,
              val:this.gstr2form.get('inum').value,
              pos:this.gstr2form.get('inum').value,
              rchrg:this.gstr2form.get('inum').value,
              inv_typ:this.gstr2form.get('inum').value,
              itms:this.gstr2form.get('inum').value,
              [
                {
