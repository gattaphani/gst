...
export class Gstr2b2bformComponent implements OnInit {
  ...
  savegstr2obj()
  {
    ...
    getgstin = localStorage.setItem('gstin','this.gstr2form.get('gstin').value,')
    getfp = localStorage.setItem('gstin','this.gstr2form.get('gstin').value,')
    getctin = localStorage.setItem('gstin','this.gstr2form.get('gstin').value,')
