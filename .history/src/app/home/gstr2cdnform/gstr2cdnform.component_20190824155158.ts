...
export class Gstr2cdnformComponent implements OnInit {
  ...
  constructor(private dataservice: DataService,private ata: DataService, private fb: FormBuilder, 
    ...
    [
      {
       ...
       this.DataService.saveGstr2cdn(Gstr2object).subscribe(response => {
