  ...
  savegst3bobj(){
    let gstr3bobject:Gstr3bobject = 
    {
      ...
      sup_details:
      {
        osup_det:
        {
          txval:this.gstr3bform.get('ret_period').value,
          iamt:this.gstr3bform.get('ret_period').value,
          camt:this.gstr3bform.get('ret_period').value,
          samt:this.gstr3bform.get('ret_period').value,
          csamt:this.gstr3bform.get('ret_period').value,
