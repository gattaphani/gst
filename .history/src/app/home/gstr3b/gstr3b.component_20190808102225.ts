...
export class Gstr3bComponent implements OnInit {
  ...
  gstr3bres: import("c:/Users/gphaneendra/Desktop/GST/new gst/src/app/home/invoice").fullobject;
...
console.log(Gstr3bobject);
this.index.saveGstr3bInvoice(Gstr3bobject).subscribe(response => {
