...
import { DataService } from '../../../../src old1/app/services/data.service';
...
getgstr3b1()
{
  this.router.navigate(['/gstr3b1form'])
}
getgstr3b2()
{
  this.router.navigate(['/gstr3b2form'])
}

getgstr3bview()
{
  this.router.navigate(['/gstr3bview'])
}
