...
b2bur:
      ...
      console.log('Gstr2b2bur',Gstr2object);

      localStorage.setItem('gstin', this.gstr2form.get('gstin').value)

      localStorage.setItem('fp',this.gstr2form.get('fp').value)

      localStorage.setItem('ctin',this.gstr2form.get('ctin').value)

    this.data.savegstr2(Gstr2object).subscribe(response => {

     this.gstr2res = response;
     
      console.log('gstr2b2burform',this.gstr2res);
      {
