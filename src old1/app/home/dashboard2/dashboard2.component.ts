...
import { gstr2object } from '../../../../src/app/home/gstr2/gstr2';
...
export class Dashboard2Component implements OnInit {
  ...
  ngOnInit() {
    this.gstr2form = this.fb.group({
     ...
     "rthsnsumimp": [null, Validators.required],
     "iamthsnsumimp": [null, Validators.required],
     "csamthsnsumimp": [null, Validators.required],
     "tx_ihsnsumimp": [null, Validators.required],
     "tx_cshsnsumimp": [null, Validators.required],
    ...
    let Gstr2object:gstr2object = 
     {
      ...
      [
        {
          ...
          sply_ty:this.gstr2form.get('sply_tytxpd').value,
          itms:
          [
            {
              num:this.gstr2form.get('numtxpd').value,
              rt:this.gstr2form.get('rttxpd').value,
              adamt:this.gstr2form.get('adamttxpd').value,
              iamt:this.gstr2form.get('iamttxpd').value,
              camt:this.gstr2form.get('camttxpd').value,
              samt:this.gstr2form.get('samttxpd').value,
              csamt:this.gstr2form.get('csamttxpd').value,
            }
          ]
        }
      ],
      itc_rvsl:
      {
        rule2_2:
        {
              iamt:this.gstr2form.get('iamtitc').value,
              camt:this.gstr2form.get('camtitc').value,
              samt:this.gstr2form.get('samtitc').value,
              csamt:this.gstr2form.get('csamtitc').value,
        },
        rule7_1_m:
        {
          iamt:this.gstr2form.get('iamt71m').value,
          camt:this.gstr2form.get('camt71m').value,
          samt:this.gstr2form.get('samt71m').value,
          csamt:this.gstr2form.get('csamt71m').value,
        },
        rule8_1_h:
        {
          iamt:this.gstr2form.get('iamt81h').value,
          camt:this.gstr2form.get('camt81h').value,
          samt:this.gstr2form.get('samt81h').value,
          csamt:this.gstr2form.get('csamt81h').value,
        },
        rule7_2_a:
        {
          iamt:this.gstr2form.get('iamt72a').value,
          camt:this.gstr2form.get('camt72a').value,
          samt:this.gstr2form.get('samt72a').value,
          csamt:this.gstr2form.get('csamt72a').value,
        },
        rule7_2_b:
        {
          iamt:this.gstr2form.get('iamt72b').value,
          camt:this.gstr2form.get('camt72b').value,
          samt:this.gstr2form.get('samt72b').value,
          csamt:this.gstr2form.get('csamt72b').value,
        },
        revitc:
        {
          iamt:this.gstr2form.get('iamtrev').value,
          camt:this.gstr2form.get('camtrev').value,
          samt:this.gstr2form.get('samtrev').value,
          csamt:this.gstr2form.get('csamtrev').value,
        },
        other:
        {
          iamt:this.gstr2form.get('iamtother').value,
          camt:this.gstr2form.get('camtother').value,
          samt:this.gstr2form.get('samtother').value,
          csamt:this.gstr2form.get('csamtother').value,
        }
      },
      cdnur:
      [
        {
          rtin:this.gstr2form.get('rtincdnur').value,
          ntty:this.gstr2form.get('nttycdnur').value,
          nt_num:this.gstr2form.get('nt_numcdnur').value,
          nt_dt:this.gstr2form.get('nt_dtcdnur').value,
          rsn:this.gstr2form.get('nt_dtcdnur').value,
          p_gst:this.gstr2form.get('nt_dtcdnur').value,
          inum:this.gstr2form.get('inumcdnur').value,
          idt:this.gstr2form.get('idtcdnur').value,
          val:this.gstr2form.get('valcdnur').value,
          inv_typ:this.gstr2form.get('inv_typcdnur').value,
          itms:
          [
            {
              num:this.gstr2form.get('numcdnur').value,
              itm_det:
              {
                rt:this.gstr2form.get('rtcdnur').value,
                txval:this.gstr2form.get('txvalcdnur').value,
                iamt:this.gstr2form.get('iamtcdnur').value,
                camt:this.gstr2form.get('camtcdnur').value,
                samt:this.gstr2form.get('samtcdnur').value,
                csamt:this.gstr2form.get('csamtcdnur').value,
              },
              itc:
              {
                elg:this.gstr2form.get('elgcdnur').value,
                tx_i:this.gstr2form.get('tx_icdnur').value,
                tx_s:this.gstr2form.get('tx_scdnur').value,
                tx_c:this.gstr2form.get('tx_ccdnur').value,
                tx_cs:this.gstr2form.get('tx_cscdnur').value,
              }
            }
          ]
        }
      ...
      [
        {
          ctin:this.gstr2form.get('ctinisd').value,
          doclist:
          [
            {
              chksum:this.gstr2form.get('chksumdoc').value,
              isd_docty:this.gstr2form.get('isd_doctydoc').value,
              docnum:this.gstr2form.get('isd_doctydoc').value,
              docdt:this.gstr2form.get('docdtdoc').value,
              itc_elg:this.gstr2form.get('itc_elgdoc').value,
              tx_i:this.gstr2form.get('tx_idoc').value,
              tx_s:this.gstr2form.get('tx_sdoc').value,
              tx_c:this.gstr2form.get('tx_cdoc').value,
              tx_cs:this.gstr2form.get('tx_csdoc').value,
